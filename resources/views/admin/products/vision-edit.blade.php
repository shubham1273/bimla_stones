...
<div class="page-inner">
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="#">Edit Product Category</a>
            </li>
        </ul>
    </div>
    <div class="page-category">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('product-vision.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="card-action">
                                ...
                                <a href="{{ route('product-vision.index') }}" class="btn btn-danger">Cancel</a>
                            </div>
                        </div>
                    </div>
                </form>
