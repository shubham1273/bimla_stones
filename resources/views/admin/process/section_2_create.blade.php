        ...
        <div class="row">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('process.section_2.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="p-0">
                                                <input type="text" name="title" class="form-control input-full" placeholder="Enter Title" value="{{ old('title') }}" required>
                                                @error('title')
