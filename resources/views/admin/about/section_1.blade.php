...
@section('title', 'About Us - Section 1')

@section('content')
<div class="page-inner">
    <div class="page-header">
        <h4 class="page-title">About Us - Section 1</h4>
    </div>
        ...
        <div class="row">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('about.section_1.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
