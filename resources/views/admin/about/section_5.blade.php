...
@section('title', 'About Us - Section 5')

@section('content')
<div class="page-inner">
    <div class="page-header">
        <h4 class="page-title">About Us - Section 5</h4>
    </div>
    <div class="page-category">
        <div class="row">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Section 5</div>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('about.section_5.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
