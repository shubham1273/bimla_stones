...
@section('title', 'About Us - Section 7')

@section('content')
<div class="page-inner">
    <div class="page-header">
        <h4 class="page-title">About Us - Section 7</h4>
    </div>
    <div class="page-category">
        <div class="row">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Section 7</div>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('about.section_7.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control summernote" rows="5" required>{{ old('description', $data->description) }}</textarea>
