<!-- footer -->
  <div class="pt-80">
    <footer class="px-12px">
      <div class="container">
        <div class="d-flex mb-40 flex-column flex-lg-row gap-4">
          <div class="d-flex gap-3 gap-sm-5 flex-row flex-lg-column footer-col-1">
            ...
            <div>
              ...
              <div class="d-flex gap-3 align-items-center social-icon mb-3">
                ...
                <a href="#" class="text-decoration-none fs-20 fw-normal">chamarajanagar, Mysore</a>
              </div>
            </div>
          </div>
            ...
            <div class="d-flex w-100 justify-content-lg-between flex-wrap justify-content-center footer-link-mobile">
              <div
                ...
                <a href="about-us.html"
                  class="footer-link fs-20 mb-0 mb-lg-3 fw-normal text-decoration-none d-block text-nowrap">About</a>
                <a href="product.html"
                ...
                <a href="process.html"
                  class="footer-link fs-20 mb-0 mb-lg-3 fw-normal text-decoration-none d-block text-nowrap">Manufacture
                  process</a>
                <a href="blogs.html"
